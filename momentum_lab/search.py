...
from .datasets import read_dataset_manifest, resolve_dataset_annualization
...
def run_search(
    ...
    Args:
        ...
        dataset: Optional offline daily CSV manifest. No network/cache fallback;
            data provenance is resume/protocol-locked and its annualization
            declaration takes precedence over ticker-based inference.
